var Index = function () {
    ...
    var runChart3 = function () {
		...
		function registerMyHandler() {
			ajaxHandler(function(d) {
				totalPoints = d; 
		...
		function ajaxHandler(callback) {
			...
			$.ajax({
					url: "/admin/dashboard/api/pageviews" ,
					method: "GET"				
				})					
				.done(function( response ) {					
					 total_Points = response.data ;
					   if(typeof callback === "function") callback(total_Points);
				})
				.fail(function() {
						 total_Points = 10;
				})
