                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading"> 
                                    <span style="margin-left:-20px;">Add Category</span> 
                                </div>
...
{!! Form::open(['url' => 'admin/category/store', 'method' => 'post', 'name' => 'form3', 'id' => 'form3', 'files' => true ]) !!}  
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                                    ...
                                                    <label class="control-label" style="margin-top:5px;">
                                                        Slug : <input name="slug" id="slug" value="category-name" class="slug" style="display: none;" /><span class="slug" style="color: #3c763d; ">category-name</span>
                                                    </label> 
                                                </div>
                                </div>
                                </div>
