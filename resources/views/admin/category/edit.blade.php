...
<link rel="stylesheet" href="<?php echo url(); ?>/plugins/bootstrap-fileupload/bootstrap-fileupload.min.css">
	...
	<span style="margin-left:-20px;">Edit Category</span> 
	</div>
	...
	{!! Form::model($category, ['url' => ['admin/category/update', $category->id], 'method' => 'put', 'name' => 'form3', 'id' => 'form3', 'files' => true  ]) !!}  
 	...
 	<div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Category Name" class="form-control" id="name" name="name" value="<?php echo $category->name; ?>"  >
                                                </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                                    ...
                                                    <label class="control-label" style="margin-top:5px;">
                                                        Slug : <input name="slug" id="slug" value="<?php echo $category->category_slug; ?>" class="slug" style="display: none;" /><span class="slug" style="color: #3c763d; "><?php echo $category->category_slug; ?></span>
                                                    </label> 
                                                </div>
                                </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group connected-group">
                                                   ...
                                                   <label class="checkbox-inline">
                                                        ...
                                                        <?php if($category->is_hidden == 1 ) { ?> checked="checked" <?php } ?>  > 
                                                    </label>
                                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group connected-group">
                                                    ...
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" class="square-green"  name="active"  value="1" <?php if($category->active == 1 ) { ?> checked="checked" <?php } ?>   > 
                                                    </label>
                                                </div>
                                </div>
                                </div>
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <div id="bnruplddiv" class="form-group">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload"> 
                                            <div class="fileupload-new thumbnail" style="width: 350px; height: 160px;"><img src="<?php echo url(); ?>/uploaded/category/thumb/<?php echo $category->banner_img;  ?>" border="0"  width="350" > 
                                            </div>
                                 ...
                                 <div id="bnruplddivr" class="form-group">
                                                    ...
                                                    <div class="fileupload fileupload-new" data-provides="fileupload"> 
                                                        <div class="fileupload-new thumbnail" style="width: 350px; height: 160px;"><img src="<?php echo url(); ?>/uploaded/category/thumb/<?php echo $category->background_img;  ?>" border="0"  width="350" > 
                                                        </div>
                                                        <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 350px; max-height: 160px; line-height: 20px;"></div> 
                                                        <div>
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div id="bnrulddivr" class="form-group">
                                                    ...
                                                    <div class="fileupload fileupload-new" data-provides="fileupload"> 
                                                        <div class="fileupload-new thumbnail" style="width: 350px; height: 160px;"><img src="<?php echo url(); ?>/uploaded/category/thumb/<?php echo $category->icon_img;  ?>" border="0"  width="350" > 
                                                        </div>
                                                        <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 350px; max-height: 160px; line-height: 20px;"></div> 
                                                        <div>
                             ...
                             <input type="hidden"  name="oldbackgndimg" value="<?php echo $category->background_img; ?>" >
                              <input type="hidden"  name="oldbannerimage" value="<?php echo $category->banner_img; ?>" >
                             <input type="hidden"  name="oldiconimage" value="<?php echo $category->icon_img; ?>" >
