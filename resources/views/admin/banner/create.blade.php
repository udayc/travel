                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading"> 
                                    <span style="margin-left:-20px;">Add Banner</span> 
                                </div>
...
{!! Form::open(['url' => 'admin/banner/store', 'method' => 'post', 'name' => 'form6', 'id' => 'form6', 'files' => true  ]) !!}  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Banner Title" class="form-control" id="banner_title" name="banner_title">
                                                </div>  
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Banner Description" class="form-control" id="banner_desc" name="banner_desc">
                                                </div>  
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Banner link" class="form-control" id="banner_link" name="banner_link">
                                                </div>
