...
@section('content')
	...
	<h1>Site Activities<small> Overall</small></h1>
	...
	<span style="margin-left:-20px;" id="showloader" >Site Activity History</span>
	...
	@if( count($site_activities)  > 0 )	
		@foreach($site_activities as $val)	
  <tr>
	<td class="center" >
	<div class="checkbox-table listChk">
	<label> <input type="checkbox" class="ulistcheckbox" name="ulist" value=""> </label>
	</div>
	</td>    
