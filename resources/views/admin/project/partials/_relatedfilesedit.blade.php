...
$('.date-picker').datepicker({ format: 'yyyy-mm-dd' }) ;
 ...
 bookIndex = <?php echo $totalRecod; ?>;
$('#bookFormnew')
        // Add button click handler
        .on('click', '.addButtonnew', function() {
            bookIndex++;
		...
		<?php 
			...
			{  
				...
				{ 
					$cpid=$rewardnval['id'];
		?>		
				    jQuery('#mySwitch_<?php echo $cpid  ?>').on('switch-change', function (e, data) {
						  
								$.ajax({		
								type:'GET',
								url:base_url+'/admin/project/changepresentstatus/'+<?php echo $cpid; ?>,
