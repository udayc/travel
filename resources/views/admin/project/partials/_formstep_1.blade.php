...
@endif
	...
	<li>
	<a href="#step-2" class="disabled" isdone="0" rel="{{ $rel }}" >
	<div class="stepNumber">2</div>
	<span class="stepDesc">Project Details</span>
	</a>
	</li>

	<li>
	<a href="#step-3" class="disabled" isdone="0" rel="{{ $rel }}" >
	<div class="stepNumber">3</div>
	<span class="stepDesc"> Rewards</span>
	</a>
	</li>
	...
	<span class="stepDesc"> Payout </span>
	</a>
	</li>												
	...
	<span class="stepDesc">Confirmation</span>
	</a>
	</li>
