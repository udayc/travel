...
<div class="container">
<!-- start: PAGE HEADER -->
@include('admin.project.partials._pageheaderother' , ['settings_form' => 'Add Project'  ]) 
<!-- end: PAGE HEADER -->
...
<span style="margin-left:-20px;">Add Project</span>
</div>


<div class="panel-body">
<form enctype="multipart/form-data" accept-charset="UTF-8" class="form-horizontal" role="form" name="add_user" action="/admin/project/store" method="POST" id="form-step-1">
...
@include('admin.project.partials._formstep_1' , ['class' => 'selected' , 'rel'=>'1' , 'isDone' => '1' ,'skey' => Session::get('last_insert_id') ])
					...
					<div class="input-group">
						...
						<div class="input-group-btn">
							<div class="btn btn-light-grey btn-file">
								<span class="fileupload-new"><i class="fa fa-folder-open-o"></i> Select file</span>
								<span class="fileupload-exists"><i class="fa fa-folder-open-o"></i> Change</span>
								<input type="file" class="file-input" name="video_attachment">
							</div>
							<a href="#" class="btn btn-light-grey fileupload-exists" data-dismiss="fileupload">
								<i class="fa fa-times"></i> Remove
							</a>
		...
		<fieldset>
			...
			<input type="hidden" name="payment_method" id="payment_method" value="Fixed Funding" >
			...
			<div class="checkbox">
			<label>
			<input type="checkbox" class="green" name="allow_overfunding" id="allow_overfunding" checked {{ isset($projectdet->allow_overfunding) ? 'checked' : ''}}  >
			Allow overfunding
			</label>
			</div>			
