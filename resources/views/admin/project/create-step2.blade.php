...
<?php if($func=="add") { ?>
<form enctype="multipart/form-data" accept-charset="UTF-8" class="form-horizontal" role="form" name="add_project" action="/admin/project/store" method="POST" id="form-step-2" >
<?php } else { ?>
...
<div class="form-group @if ($errors->has('address')) has-error @endif">
			...
			<label for="address_alternate" class="col-sm-2 control-label">
			Address(Optional) <span class="symbol required"></span>
			</label>
			<div class="col-sm-9">
