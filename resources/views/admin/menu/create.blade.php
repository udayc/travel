...
@section('content')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading"> 
                                    <span style="margin-left:-20px;">Add Menu</span> 
                                </div>
	...
	{!! Form::open(['url' => 'admin/menu/store', 'method' => 'post', 'name' => 'form5', 'id' => 'form5'  ]) !!}  
	...
	<input type="text" placeholder="Menu Name" class="form-control" id="name" name="name">
	</div>  
	</div>    
	</div>
	...
	<div class="form-group">
	<label class="control-label">
	slug url key : <input name="slug" id="slug" value="" class="slug" style="display: none;" /><span class="slug" style="color: #3c763d; ">demo_title</span>
	</label> 
	</div>  
	</div>    
	</div>	
	...
	<div class="col-md-4">
		...
		<div>	
			...
			<input type="checkbox"  class="green" name="add_to_header_menu" id="add_to_header_menu"   required >
			Add to header menu
			</label>
			...
			<input type="checkbox"  class="green" name="add_to_footer_menu" id="add_to_footer_menu"    >
			Add to footer link
			</label>
			<span class="help-block"><i class="fa fa-info-circle"></i> 
