...
@section('content')
	...
	<h1>Music Category Management<small> Manage core config data</small></h1>
	<div class="row">
	<a href="<?php echo url(); ?>/admin/category/approvedrec" class="col-sm-1 listing_stus"><?php echo $actctng; ?> <br> <span class="label label-success"> Active</span></a>
	<a href="<?php echo url(); ?>/admin/category/disapprovedrec" class="col-sm-1 listing_stus"><?php echo $deactctng; ?> <br> <span class="label label-danger"> Inactive</span></a>
	<a  href="<?php echo url(); ?>/admin/category/unsetsearchparameter"  class="col-sm-1 listing_stus"><?php echo ( $actctng + $deactctng); ?> <br> <span class="label label-default">All</span></a>
	<div class="col-sm-9">
	...
	<span style="margin-left:-20px;" id="showloader" >Music Category - 
...
<?php /* ?>
	...
	{!! Form::open(['url' => 'admin/category/searchparameter', 'method' => 'post', 'class' => 'form-horizontal panel']) !!}  
...
<?php */ ?>
	...
	<thead>
	<tr>
	<th  class="center nosort" width="10%" >
