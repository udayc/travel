 @if( count($_projectLists) > 0 )     
              ...
              <div>
                <h3>{!! str_limit($project->name, $limit = 30, $end = '...') !!}</h3>
                <div class="catview_IMG"><a href="{{ Url::to('project/'.$project->id.'/'.$project->slug)}}" title="{{ $project->name }}" >
				<img src="/images/file-attached-to-project/resize/medium/{{ $project->file_attachment }}" alt="{{ $project->file_attachment }}" border="0" width="628" height="267"></a>
                ...
                <div class="catviewDtetlArea"> 
                  ...
                  <div class="catRgtBx">
                    ...
                    <a href="{{ Url::to('project/'.$project->id.'/'.$project->slug)}}" class="orenge_btn">Explore Project3</a> </div>
                  <!-- right part closed --> 
