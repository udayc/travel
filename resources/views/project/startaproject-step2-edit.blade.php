  ...
  <div class="container">
    <div class="row">
      ...
      <!-- menu open -->
        ...
        <form enctype="multipart/form-data" accept-charset="UTF-8" class="form-horizontal" role="form" name="addprojectsec" action="/project/updateproject" method="POST" id="addprojectsec">
        <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
        <input type="hidden" name="step" value="2">
         <input type="hidden" name="_secret_key_" value="<?php echo $last_insert_id;  ?>">
      ...
      <h3>Location</h3>
        ...
        <button type="button" class="btn btn-default MidgrayButton wow fadeInLeft" name="submit-btn" id="back-step-26" value="1" data-token="{{ csrf_token() }}" >BACK</button>
