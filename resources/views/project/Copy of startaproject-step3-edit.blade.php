...
<form class="form-horizontal" role="form" name="addprojectthirde" id="addprojectthirde"  action="/project/store"  enctype="multipart/form-data" accept-charset="UTF-8" method="POST"  >
...
<input name="_secret_key_"   id="projectid"  type="hidden" value="<?php echo $last_insert_id;  ?>">
      ...
      ?>           
          ...
          <div class="qutrFld">
               <select name="delevery_year[]" id="delevery_year" class="form-control" <?php if($projectdet->active == 1){ ?>readonly=""<?php } ?> >
          ...
          <div class="col-lg-12 col-xs-12 formFldArea">
          <label><span>Reward active status</span><span class="star">*</span></label>
